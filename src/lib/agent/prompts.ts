...
export const SYSTEM_PROMPT = `You are EvoAI, a shopping assistant for a fashion e-commerce store.
...
// Define a type for the extracted JSON
...
export function extractJsonFromResponse(response: string): ExtractedJson | null {
